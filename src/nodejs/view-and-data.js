...
module.exports = function(config) {
      ...
      _self.getToken().then(
        ...
        function(response){
         ...
         //   _refreshToken(arguments.callee);
			...
			result = {"access_token":_token,"token_type":response.token_type};
        ...
        function(error){
          ...
          _token = null;
			console.log("Error has occure in line 116");
			console.log(error);
          reject(error);
        });
    });
  ...
  //
  ///////////////////////////////////////////////////////////////////
  _self.getToken = function(scope) {

    var params = {
      client_secret: config.credentials.clientSecret,
      client_id: config.credentials.clientId,
      grant_type: 'client_credentials',
      scope: scope || config.scope.join(' ')
    };
    console.log(config.endPoints.authenticate);
  ...
  _self.getBucket = function(
	...
	console.log(config.endPoints.createBucket);
	console.log(JSON.stringify(bucketCreationData));
	console.log("begin creation");
	//exit();	//exit on this error
      request.get({
          url: getBucketUrl,
          headers: {
            'Authorization': 'Bearer ' + _token,
...
console.log(config.endPoints.register);
//exit();
      request.post({
...
//console.log(body);
  ...
  ///////////////////////////////////////////////////////////////////
   ...
   _self.modelView = function(urn) {
	var modelViewUrl = util.format(
        config.endPoints.modelView, urn);
        console.log(modelViewUrl);
    var promise = new Promise(function(resolve, reject) {
  ...
  ///////////////////////////////////////////////////////////////////
   ...
   _self.objectTree = function(urn, guidStr) {
	var objectTreeUrl = util.format(
        config.endPoints.objectTree, urn, guidStr);
        console.log(objectTreeUrl);
        //console.log(guidStr);
    var promise = new Promise(function(resolve, reject) {
...
//console.log(res);
  ...
  //
  ////////////////////////////////////////////////////////////////////////
  _self.download = function(urn, directory) {
//console.log(urn);
